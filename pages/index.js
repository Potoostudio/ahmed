    ...
    <div className="container pt-lg-0 pt-5 bg-dark">
      ...
      <div className="row justify-content-center pt-5">
        ...
        <div className="col-8 pt-5 mt-5">
          ...
          <h2 className="about-h2 pt-3 w-55">
          I'm extremely inspired by people's stories and goals. Every story is unique and must be supported by unique brand strategy, logo, graphics, and website.
            </h2>
            <h2 className="about-h2 pt-3 w-55">
            My learning motivation comes from the challenges I take. I love doing interesting things that matter and make changes in clients' lives.
            </h2>
        </div>
        ...
        <div className="col-8 col-sm-8 pt-3 pb-5">
          <h3 className="Links h3-border">
            Design
          </h3>
          <ul className="list links">
